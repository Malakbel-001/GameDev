...
void HUD::Draw(float dt, float manipulatorSpeed) {
...
void HUD::DrawTimer(float dt, float manipulatorSpeed) {
	...
	//Draw Timer
	if (timer != nullptr) {
		timer->AddDeltaTime(dt*manipulatorSpeed);
